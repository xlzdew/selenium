...
import org.openqa.selenium.remote.SRobot;
import org.openqa.selenium.remote.server.JsonParametersAware;
import org.openqa.selenium.remote.server.Session;
import org.openqa.selenium.remote.server.handler.WebDriverHandler;
import org.openqa.selenium.remote.server.rest.ResultType;

public class RobotKeyRelease extends WebDriverHandler implements JsonParametersAware{
	  	private int key;
	  	public RobotKeyRelease(Session session) {
	    super(session);
	  }
		...
		public void setJsonParameters(Map<String, Object> allParameters)
				throws Exception {
			int rawKey = Integer.parseInt(String.valueOf(allParameters.get("value")));
			key=rawKey;
	  ...
	  private void callRobotEvent(Robot robot, int keyToRelease){
